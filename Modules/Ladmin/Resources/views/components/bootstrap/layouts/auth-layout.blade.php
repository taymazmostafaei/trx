            ...
            <div class="d-flex align-items-center me-3">
                ...
                <a href="" class="lh-1 text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu mt-3">
                        <li><a class="dropdown-item" href="{{ route('ladmin.profile.index') }}">پروفایل</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="javascript:document.getElementById('logout').submit();">خروج</a></li>
                    </ul>
                </a>
            </div>
        </header>
