        ...
        <div class="col-lg-4 col-md-6 col-sm-10 col-xs-10">
            ...
            <form action="{{ route('ladmin.password.send-link-email') }}" method="POST">
                ...
                <x-ladmin-card class="mx-3 mb-5 rounded-lg">
                    <x-slot name="body">
                        <h5 class="mb-3">بازیابی رمز عبور</h5>

                        <x-ladmin-alert class="mb-3" />

                        <x-ladmin-input class="mb-3" placeholder="آدرس ایمیل" name="email" type="email" />
            ...
            <div class="text-center">
                <a href="{{ route('ladmin.login') }}">&larr; بازگشت به ورود</a>
            </div>
        </div>
    </div>
